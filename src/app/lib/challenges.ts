...
export const DAILY_CHALLENGES: DailyChallengeDef[] = [
  ...
  { theme: 'Alkanes', description: 'Build a molecule with sp3 carbon–hydrogen bonds (single bonds only on carbon).', constraints: [{ smarts: '[CX4]', label: 'sp3 carbon' }, { smarts: '[CH3,CH2,CH]', label: 'alkyl group' }], difficulty: 1 },
  ...
  { theme: 'Nitrogen Heterocycles', description: 'Build a molecule with nitrogen in an aromatic ring (pyridine, pyrrole, imidazole…).', constraints: [{ smarts: '[n]', label: 'nitrogen in aromatic ring' }], difficulty: 5 },
  ...
  { theme: 'Methyl Groups', description: 'Build a molecule with at least two –CH₃ groups (e.g. propane, acetone).', constraints: [{ smarts: '[CH3][CH3,CH2,CH,C].[CH3][CH3,CH2,CH,C]', label: 'two distinct –CH₃ groups' }], difficulty: 2 },
